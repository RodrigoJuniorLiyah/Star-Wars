...
import { characterANewHope, planetANewHope, starshipsANewHope, vehiclesANewHope } from "./data";
    ...
    <CategoryStarshipsContainer>
      ...
      <BoxInfo>
        ...
        <StarshipsCategoryStatus>
          ...
          {"\n"}
          <StrongText>Passageiros:</StrongText>{" "}
          {vehicles.passengers}
        </StarshipsCategoryStatus>
      </BoxInfo>
    </CategoryStarshipsContainer>
...
export { CategoryList, PlanetsCategoryList, StarshipsCategoryList, VehiclesCategoryList };
